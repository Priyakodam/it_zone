  ...
  return (
    <div className="service-cards" ref={cardsRef}>
      ...
      <div className={`service-card ${showCards.includes(1) ? "show" : ""}`}>
        <img
          src="https://thumbs.dreamstime.com/b/add-to-cart-internet-web-store-buy-online-e-commerce-concept-153472985.jpg"
          alt=""
          className="service-img"
        />
        <h3>Contact us</h3>
        <p>
          Get in touch with IT-Zone and find the right resources to help.
        </p>
      </div>
      <div className={`service-card ${showCards.includes(2) ? "show" : ""}`}>
        ...
        <h3>Our purpose</h3>
        <p>
          Our purpose is at the core of who we are and what we do.
        </p>
      </div>
      <div className={`service-card ${showCards.includes(3) ? "show" : ""}`}>
        ...
        <p>
          IT-Zone delivers end-to-end value by driving advances across a wide
          spectrum of industrial technologies.
        </p>
      </div>
    </div>
  );
