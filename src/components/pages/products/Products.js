  ...
  <div className="background-container" >
    ...
    <div className="card">
        ...
        <div className="row">
          ...
          <div className="col-md-12 ">
       <p>iTZ-ONE provides you with software installation services at convenient rates. You must be thinking that why you need a company when you can install software on your own? Well, we have seen a drastic change in the computing industry over the past few years. Know the size of computers has become small and they work at an exceptional speed and this is because of the modern software technology. Various complex software has been introduced in the market by different organizations and installing highly complex software is not easy as it required a lot of time and energy. We are living in a world where computers and laptops have completely taken over us. Our life wouldn’t work without this electronic equipment. They have become the primary part of our lives, especially after the covid crisis.  People who are familiar with the technicalities of computers can easily install any sort of software. However, people who are not familiar with the complexities of modern-day computers, wouldn’t install large and complicated software, on their own. To help people in dealing with such complexed software our technicians are providing remarkable services. We take your stress away by providing you with the latest software installation services for your laptops, computers, and desktops. 
...
We assure you that we’ll install the correct software for your computers. Another thing that we guarantee you is we provide you with legal and virus-free software. Whether you need OS installation and repairing services or software installation services, our experts will just help. </p>  </div>
    ...
    <div className="card">
        ...
        <div className="row">
          ...
          <div className="col-md-12 ">
       <p>iTZ-ONE is provide all types of enterprise software.</p>  </div>
